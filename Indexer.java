...
public class Indexer {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		BasicDBObject x = new BasicDBObject("IDF",new BasicDBObject("$exists", false));
		MongoCursor<Document> documentsCursor1 = mongoCollection_Indexer.find(x).cursor();
		MongoCursor<Document> documentsCursor2 = mongoCollection_Indexer.find(x).cursor();
		try {
	...
	public static ArrayList<String> loadStopwords() throws FileNotFoundException {
		Scanner scanner = new Scanner(new File("src/APT_Project/StopWords.txt"));
